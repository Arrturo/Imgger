...
import { Form, Button, Row, Col, Table, Image, Pagination} from "react-bootstrap";
  ...
  return (
    <div>
      <h1 className="text-4xl text-center mb-5">
        ...
        ? ` - Showing ${activePage * postsPerPage - postsPerPage + 1} to ${postsCount} posts`
        : ` - Showing ${activePage * postsPerPage - postsPerPage + 1} to ${activePage * postsPerPage} posts`}
  </span>
)}
      </h1>
