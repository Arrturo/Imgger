						...
						<Form onSubmit={editDataSubmitHandler}>
							...
							<Form.Group controlId="name">
								...
								<Form.Control
									...
									value={editName}
									onChange={(ele) => setEditName(ele.target.value)}
								></Form.Control>
							</Form.Group>
						...
						<tr key={category.node.id}>
							...
							<td>
								<Button varinat="light" className="btn-m">
									<i
										class="fa-regular fa-pen-to-square text-lime-500"
										onClick={() => {
											setEdit(true);
											setEditdata(category.node.id, category.node.name);
										}}
									></i>
								</Button>
								<Button
									...
									className="btn-m"
									onClick={() =>
										deleteHandler(category.node.id, category.node.name)
									}
								>
