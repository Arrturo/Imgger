					...
					<Navbar.Collapse id="navbarScroll">
						...
						<Nav className="my-2 my-lg-0 ms-auto p-1 gap-5 " navbarScroll>
							<LinkContainer to="/newpost">
								<Nav.Link className="hover:text-amber-500 text-amber-200">
									{" "}
							...
							{userInfo?.user?.isStaff && (
								...
								>
									<LinkContainer to="/admin/categoriesList">
										<NavDropdown.Item className="hover:text-amber-400">
							...
							{userInfo ? (
								<NavDropdown
									title={`Hello ${userInfo?.user?.username} !`}
									id="username"
									className="pr-5"
								>
									...
									<LinkContainer to="/myposts">
										<NavDropdown.Item className="hover:text-amber-400">
											<i class="fa-solid fa-images"></i> My posts
										</NavDropdown.Item>
									</LinkContainer>
									<NavDropdown.Item
